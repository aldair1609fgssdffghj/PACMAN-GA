...
public class Inputs_Pacman {
	...
	public void init(){
		...
		MiTrapecio[] distancia_param = new MiTrapecio[3];
		...
		distancia_ghost.setName("Distancia");
		...
		distanciaPowerPills.setName("NumeroPowerPills");
		...
		distanciaPill.setName("NumeroPills");
